...
public class GCMIntentService extends GCMBaseIntentService {
	 ...
	 * Add by Fred
	 */
	private void tryPlayRingtoneUri(Uri MyUri) 
	{
		try {
			//RingtoneManager.setActualDefaultRingtoneUri (getApplicationContext(), RingtoneManager.TYPE_NOTIFICATION, MyUri);
			Ringtone r = RingtoneManager.getRingtone(getApplicationContext(), MyUri);
			r.play();
		} 
		catch (Exception e) {
			Log.e(TAG, "failed to play notification ringtone Uri");
		}
	}
